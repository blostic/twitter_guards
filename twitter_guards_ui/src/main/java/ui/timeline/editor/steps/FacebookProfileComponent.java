...
public class FacebookProfileComponent extends HorizontalLayout {

	private static final long serialVersionUID = 1L;

	private String value;

	public FacebookProfileComponent(String value, FacebookProfileStep keywordsSpecification) {
		this.setValue(value);
		...
		exitButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				keywordsSpecification.removeKeyword(FacebookProfileComponent.this);
			}
		});
